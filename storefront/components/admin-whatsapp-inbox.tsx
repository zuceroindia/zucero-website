          ...
          {selected && (
            <>
              ...
              <p className={styles.windowNote}>
                💡 <strong>Meta messaging:</strong> Free-form replies are for an open customer-service window. When the window is closed, use one of the approved Meta template buttons in the linked order panel above.
              </p>
            </>
          )}
        </section>
