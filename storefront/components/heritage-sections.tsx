...
export function CollectionSection() {
  return <>
    ...
    <section id="products" className="heritage-collection">
      ...
      <header><span className="heritage-rule" /><p>Each one distinct. Each one with a story older than the brand.</p><div className="collection-launch-callout"><p className="eyebrow">Experience the goodness of the first batch</p><p className="collection-access-line">Introductory price for first 100 orders only <span>·</span> Deliveries begin</p><p className="collection-coupon-offer">Get an additional discount of 10% on referral.</p></div></header>
