...
export function CollectionSection() {
  return <>
    ...
    <section id="products" className="heritage-collection">
      ...
      <header><span className="heritage-rule" /><p>Each one distinct. Each one with a story older than the brand.</p><div className="collection-launch-callout"><p className="eyebrow">Experience the goodness of the first batch</p><p className="collection-access-line">Priority access <span>·</span> Deliveries begins</p><p className="collection-coupon-offer"><strong>Extra 10% off:</strong> use coupon <strong>ZUCADD10</strong> at checkout.</p></div></header>
