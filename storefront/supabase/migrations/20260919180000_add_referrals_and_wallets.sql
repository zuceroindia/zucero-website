-- 20260919180000_add_referrals_and_wallets.sql (idempotent v2)
-- Run this in Supabase SQL Editor: https://supabase.com/dashboard/project/ittppvdsiyvckdpcjktj/sql/new
...
-- ─── 6. Policies (drop first so re-runs are safe) ────────────────────────────
...
create policy "Allow service_role full access on referral_codes"
...
create policy "Allow service_role full access on wallet_transactions"
